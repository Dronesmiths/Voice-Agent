          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(350px, 1fr))", gap: "24px" }}>
            ...
            <div className="card" style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div style={{ display: "flex", gap: "12px", marginTop: "8px" }}>
                ...
                <Link href="/settings/don" className="btn btn-outline" style={{ flex: 1, textDecoration: "none", textAlign: "center" }}>Settings</Link>
            ...
            <div className="card" style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div style={{ display: "flex", gap: "12px", marginTop: "8px" }}>
                <button className="btn btn-outline" style={{ flex: 1 }}>Call logs</button>
                <Link href="/settings/brian" className="btn btn-outline" style={{ flex: 1, textDecoration: "none", textAlign: "center" }}>Settings</Link>
                <button className="btn btn-outline" style={{ width: "42px", flexShrink: 0 }}>📞</button>
              </div>
            </div>
